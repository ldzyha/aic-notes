...
Послідовність випуску 54 · 0 нових можливостей · 2 виправлені помилки. Випуск
узгоджений із Standard Notes AIC 46.0.2, експериментальним браузером 0.9.2 та ядром 7.3.2.
