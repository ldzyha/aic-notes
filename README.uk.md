...
Випуск **52.1.0** на спільному ядрі **7.3.0** має однаковий вигляд і сортування
AIC-рядків у головному редакторі та Linked Note. Він узгоджений зі Standard Notes
AIC **44.1.0** та експериментальним розширенням браузера **0.9.0**.
...
Завантажте `aic-notes-52.1.0.vsix` зі
[сторінки випуску](https://github.com/ldzyha/aic-notes/releases/tag/v52.1.0).
