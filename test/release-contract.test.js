...
test("42.0.3 is a universal local editor without account connectivity", () => {
  assert.equal(packageJson.version, "42.0.3");
  assert.equal(packageJson.aicEditorCore, "5.2.0");
