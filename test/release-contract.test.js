...
test("41.1.1 is a universal local editor without account connectivity", () => {
  assert.equal(packageJson.version, "41.1.1");
  assert.equal(packageJson.aicEditorCore, "5.1.0");
